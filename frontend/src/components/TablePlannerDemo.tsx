...
// Demo mock data con SOLO ospiti confermati
const mockConfirmedGuests: TableGuest[] = [
  {
    id: "g1",
    name: "Marco Rossi",
    ...
    user_id: "demo",
    confermato: true // ✅ Solo confermati
  },
  {
    id: "g2",
    name: "Anna Bianchi",
...
const TablePlannerDemo: React.FC = () => {
  ...
  const [guests, setGuests] = useState<TableGuest[]>(mockConfirmedGuests);
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Piano Tavoli - Solo Ospiti Confermati ✅</h1>
              <p className="text-gray-600 mt-1">Sistema avanzato per la disposizione degli ospiti confermati</p>
            </div>
